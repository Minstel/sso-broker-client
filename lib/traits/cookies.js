...
function cookieTrait() { 
    ...
    this.setCookie = function(token) {
        ...
        this.window.document.cookie = this.cookieName + '=' + token + ';path=/;expires=' + expires.toUTCString();
    }   
    ...
    this.clearCookie = function() {
        ...
        this.window.document.cookie = this.cookieName + '=;path=/;expires=' + expires.toUTCString();
    }
